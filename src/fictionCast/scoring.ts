...
function fictionCastScoreWeights(settings: GenerationSettings): Record<ScoreKey, number> {
...
export function combineFictionCastOverallFit(scores: Pick<NameScores, ScoreKey>, settings: GenerationSettings): number {
