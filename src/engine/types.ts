...
export interface GeneratedName { id: string; name: string; sound: SoundCandidate; rankedSpellings: readonly RankedSpellingCandidate[]; silhouette: NameSilhouette; scores: NameScores; variants: NameVariant[]; role?: CastRoleAssignment; roleInfluence?: RoleInfluenceMetadata; readabilityDiagnostics: ReadabilityDiagnostic[]; identity?: NameIdentity; }
