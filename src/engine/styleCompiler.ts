import type { SoundProfile, SoundProfileCadence, SoundProfileLength, SoundProfileTexture } from './soundProfile';
...
export function compileStyle(input: StyleInput = {}): SoundProfile {
  ...
  return {
    ...
    version: 1,
    id: `sound-profile:${style.feel}:${style.length}:${style.distinctiveness}`,
    source: {
      kind: 'style-input',
